...
The <<Referee, referee>> asks the <<Robot Handler, robot handlers>> for their preferred <<Hull Color of Robots, robot hull color>> (dark or bright). If teams agree, the colors are used; otherwise, the referee assigns them by chance.
